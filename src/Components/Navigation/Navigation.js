  ...
  return (
    <div>
      ...
      <div className={style.tab}>
        ...
        <Link to={{pathname: `/`, state: {from: location}}} className={style.tab_navItem}>
          ...
          <Link to={{pathname: `/statistic`, state: {from: location}}}  className={style.tab_navItem}>
          <div className={style.tab_navItem}>
          ...
          <div className={style.tab_dash}></div>
          <Link to={{pathname: `/currency`, state: {from: location}}} className={style.tab_navItem}>
          <div className={style.tab_navItem}>
